        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            {PRESET_USERS.map((user) => (
              <button key={user.id} onClick={() => handlePresetLogin(user)} className="glass-card p-3 rounded-xl border border-slate-800 text-left hover:border-mvu-500/50 transition-all group flex items-center justify-between">
                <div className="space-y-0.5">
